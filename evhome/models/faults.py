...
class Faults(models.Model):
    ...
    fault_type = models.ForeignKey(FaultTypes, on_delete=models.CASCADE, db_column='fault_type_id')
    charge_point_location = models.ForeignKey(ChargePointLocations, on_delete=models.CASCADE, db_column='charge_point_location_id')
    charge_point = models.ForeignKey(ChargePoints, on_delete=models.CASCADE, db_column='charge_point_id')
