...
class Orders(models.Model):
    ...
    order_type = models.ForeignKey(
        OrderTypes, on_delete=models.CASCADE, db_column="order_type_id"
    )
...
class OrderStatus(models.Model):
    ...
    order_status_type = models.ForeignKey(
        OrderStatusTypes, on_delete=models.CASCADE, db_column="order_status_type_id"
    )
    timestamp = models.DateTimeField()
    meter_value = models.FloatField()
    amount = models.FloatField()
    reason_type = models.ForeignKey(
        OrderStatusReasonTypes, on_delete=models.CASCADE, db_column="reason_type_id"
    )
