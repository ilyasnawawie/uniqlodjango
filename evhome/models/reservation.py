...
class ReservationStatus(models.Model):
    id = models.AutoField(primary_key=True)
    reservation = models.ForeignKey(Reservations, on_delete=models.CASCADE, db_column='reservation_id')
    reservation_status_type = models.ForeignKey(ReservationStatusTypes, on_delete=models.CASCADE, db_column='reservation_status_type_id')
