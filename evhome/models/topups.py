...
class TopUp(models.Model):
    ...
    type = models.ForeignKey(
        TopUpType, related_name="top_ups", on_delete=models.CASCADE
    )
    ...
    user_group_user = models.ForeignKey(
        UserGroupUser, related_name="top_ups", on_delete=models.CASCADE
    )
    operated_by = models.ForeignKey(
        User, related_name="operated_top_ups", on_delete=models.CASCADE
    )
...
class TopUpStatus(models.Model):
    ...
    top_up_status_type = models.ForeignKey(
        TopUpStatusType, related_name="statuses", on_delete=models.CASCADE
    )
