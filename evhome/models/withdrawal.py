...
class Withdrawal(models.Model):
    id = models.AutoField(primary_key=True)
    type = models.ForeignKey(WithdrawalType, related_name='withdrawals', on_delete=models.CASCADE)
    ...
    user_group_user = models.ForeignKey(UserGroupUser, related_name='withdrawals', on_delete=models.CASCADE)
    operated_by = models.ForeignKey(User, related_name='operated_withdrawals', on_delete=models.CASCADE)
...
class WithdrawalStatus(models.Model):
    id = models.AutoField(primary_key=True)
    withdrawal = models.ForeignKey(Withdrawal, related_name='statuses', on_delete=models.CASCADE)
    withdrawal_status_type = models.ForeignKey(WithdrawalStatusType, related_name='statuses', on_delete=models.CASCADE)
